...
namespace Lab2pnyavy
{
    class Mystring
    {
        ...
        public static bool operator ==(Mystring obj1, Mystring obj2) // по длине
        {
        ...
        public static int Compare (Mystring obj1, Mystring obj2) // по алфавиту
        {
            int result = 0;
        ...
        //методы
        //1 метод
        public Mystring Replace(Mystring Str, char Old, char New, bool flag)
        {
            string TempText;
